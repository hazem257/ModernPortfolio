...
const fetchStudents = async () => {
  ...
  return (
    <header className="header">
      <div className="info">
        <a href="https://www.facebook.com/hazemgm21/" target="_blank" rel="noopener noreferrer">
          <img
            className="dragon-logo"
            src={isDarkTheme ? "/E2.png" : "/E1.png"}
            alt="Logo"
          />
        </a>
  ...
  <svg viewBox="0 0 69.667 44" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
      ...
      <div className="user-auth">
        {!user ? (
          <>
            <a className="login" href="/login">تسجيل دخول</a>
            <a className="signup" href="/register">انشاء حساب جديد</a>
          </>
        ) : (
          <div className="user-menu" ref={menuRef}>
            ...
            >
              <img
  className="user-logo"
  src={`${API_BASE}/${formData.userLogo}`|| "/hazem1.png"}
  alt={user.firstName}
/>
